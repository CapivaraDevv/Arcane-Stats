    ...
    <div className="relative z-10 w-full">
      <ResponsiveContainer width="100%" height={200}>
        <LineChart data={data}>
          ...
          <XAxis dataKey="partida" stroke="#A8A8A8" style={{ fontSize: '12px' }} />
          <YAxis stroke="#A8A8A8" style={{ fontSize: '12px' }} />
          <Tooltip contentStyle={{ backgroundColor: '#0B132B', border: '1px solid #0077B6', borderRadius: 8, color: '#E0E0E0' }} formatter={(v: number) => v.toFixed(1)} />
