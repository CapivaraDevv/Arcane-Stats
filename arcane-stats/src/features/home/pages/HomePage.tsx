        ...
        <div className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-2">
          <div className="text-left">
            ...
            <motion.p
              ...
              className="font-sans mt-5 text-slate-300 max-w-xl text-base md:text-lg"
            >
            ...
            >
              ...
              <Link
                to="/register"
                className="font-display border border-slate-600 px-6 py-3 rounded-xl hover:bg-slate-800 hover:border-[hsl(var(--primary)/0.7)] transition-all font-semibold"
              >
      ...
      <section className="relative z-10 mt-12 px-6">
        ...
        >
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <article className="rounded-xl border border-slate-800 bg-slate-800/70 p-4">
              <h3 className="text-lg font-semibold text-[#00B4D8]">
                O que é eSports e por que existem estatísticas?
              </h3>
              <p className="mt-2 text-sm text-slate-300">
          ...
          <div className="mx-auto w-full max-w-6xl">
            <div className="mb-10 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
              ...
              <p className="max-w-sm text-sm text-muted-foreground">
                Sem 47 abas, sem planilha. Os 3 números que importam — e a
                decisão errada que ligou tudo.
              </p>
            </div>
                  ...
                  <div className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="rounded-full bg-[hsl(var(--destructive)/0.15)] px-2 py-0.5 text-[10px] font-medium text-destructive">
                          crítico
                        </span>
                      </div>
                      <p className="mt-2 text-base text-foreground">
                        ...
                        . Recue para a base após o segundo abate na bot e
                        recupere{" "}
                        <span className="font-semibold text-primary">
                          +340 ouro
                        </span>
